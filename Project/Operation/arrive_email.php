...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Arrival Information of FoodEdge Gourmet Catering</title>
        ...
        <table align="center" border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse; width: 100%; max-width: 600px;" class="content">
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                        <tr>
                            <td align="center" style="color: #000; font-family: Arial, sans-serif; font-size: 12px;">
                                Email not displaying correctly?  <a href="http://<?=$_SERVER['HTTP_HOST'].dirname($_SERVER['PHP_SELF'])?>/arrive_email.php" style="color:#0073AA;">View it in your browser</a>
                            </td>
                        </tr>
                    </table>
                </td>
            ...
            <tr>
                <td align="center" bgcolor="#ffffff" style="padding: 75px 20px 40px 20px; color: #555555; font-family: Arial, sans-serif; font-size: 20px; line-height: 30px; border-bottom: 1px solid #f6f6f6;">
                    <b>Hello</b><br>
                    Your Order is arrive to your destination<br>
					Please provide rating and comment to your order within 14 day<br>
					Hope we can meet again, Thank You
                </td>
            </tr>
            <tr>

                                        ...
                                        <div class="col-lg-5">
                                            ...
                                            <div class="tab-content pt-0">
                                                <div class="tab-pane active show" id="product-1-item">
                                                    <img src="../<?php echo $rows['product_image']?>" alt="" class="img-fluid mx-auto d-block rounded">
                                                </div>
                                            </div>
                                        </div> <!-- end col -->
                                        <div class="col-lg-7">
                                            <div class="pl-xl-3 mt-3 mt-xl-0">
												<?php							
													...
													$rows = $db->getOne("tbl_product");
												?>
                                                <a href="#" class="text-primary"><?php echo $rows['product_type']?></a>
                                                <h4 class="mb-3"><?php echo $rows['product_name']?></h4>
                                                ...
                                                <p class="text-muted mb-4">
													<?php 
														$db->where("product_detail_id = '1'"); 
														$rows = $db->getOne('tbl_product_detail'); 	
														echo $rows['product_detail_desctiption'];
													?>
												</p>
                                                ...
                                                <form class="form-inline mb-4">
													...
													<label class="my-1 mr-2" for="sizeinput">Status:</label>
													<?php 
														$db->where("product_detail_id = '1'"); 
														$rows = $db->getOne('tbl_product_detail'); 	

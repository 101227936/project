...
<html lang="en">
    <head>
    <meta charset="utf-8" />
        <title>Operation Account Details<?=$_GET['account_id']?></title>
    ...
    <body>
		<?php
			...
			$db->where("tbl_staff.staff_id", $_GET['account_id']);
		...
		<?php
            if(isset($_POST['accountName'])&&isset($_POST['accountPhone'])&&isset($_POST['accountAddress'])&&isset($_POST['accountEmail']))
			{
				...
				echo "<script> alert('Update Successful');location='account_detail.php?account_id=".$_GET['account_id']."'</script>";
			}
		?>
                            ...
                            <div class="col-lg-6 col-xl-6">
                                <div class="card-box">
                                    <ul class="nav nav-pills navtab-bg nav-justified">
                                        <li class="nav-item">
                                                <h3>Update Operation Account Here</h3>
                                        </li>
                                    </ul>

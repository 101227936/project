        ...
        <table align="center" border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse; width: 100%; max-width: 600px;" class="content">
            <tr>
                <td align="center" bgcolor="#ffffff" style="padding: 0px 20px 20px 20px; color: #555555; font-family: Arial, sans-serif; font-size: 30px; line-height: 30px;">
                    ...
                    <br><br><br>
                    <label style="font-size:15px">*You can unsubscribe it by clicking the <a href="http://<?=$_SERVER['HTTP_HOST'].dirname($_SERVER['PHP_SELF'])?>/unsubscribe.php?subscribe_email=<?=$_GET['subscribe_email']?>" style="color: #FF0000; text-align: center; font-size:15px;text-decoration:underline;" target="_blank">UNSUBSCRIBE</a></label>
                </td>
            </tr>
            <tr>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                        <tr>
                            <td align="center" style="color: #000; font-family: Arial, sans-serif; font-size: 12px;">
                                Email not displaying correctly?  <a href="http://<?=$_SERVER['HTTP_HOST'].dirname($_SERVER['PHP_SELF'])?>/subscribe_email.php?subscribe_email=<?=$_GET['subscribe_email']?>" style="color:#0073AA;text-decoration:underline;" target="_blank">View it in your browser</a>
                            </td>
                        </tr>
                    </table>
                </td>
